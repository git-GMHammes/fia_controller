...
class SegurancaApiController extends ResourceController
{
    use ResponseTrait;
    ...
    public function __construct()
    {
        ...
        $this->DbController = new SegurancaDbController();
    ...
    # route POST /# www/index.php/fia/ptpa/seguranca/api/filtrar/(:any)
    # route GET /# www/index.php/fia/ptpa/seguranca/api/filtrar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
