...
class GeneroIdentidadeEndpointController extends ResourceController
{
    use ResponseTrait;
    ...
    public function dbRead($parameter = NULL)
    {
        ...
        $loadView5 = array(
            ...
            'fia/ptpa/generoidentidade/listar',
            $this->app_footer,
        );
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'LISTAR GENERO IDENTIDADE',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LISTAR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/generoidentidade/endpoint/cadastrar/(:any)
    # route POST /www/index.php/fia/ptpa/generoidentidade/endpoint/cadastrar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbCreate($parameter = NULL)
    {
        ...
        #
        $loadView5 = array(
            'fia/ptpa/generoidentidade/formulario',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        #
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'CADASTRAR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - CADASTRAR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/generoidentidade/endpoint/atualizar/(:any)
    # route POST /www/index.php/fia/ptpa/generoidentidade/endpoint/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbUpdate($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'ATUALIZAR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - ATUALIZAR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/generoidentidade/endpoint/deletar/(:any)
    # route POST /www/index.php/fia/ptpa/generoidentidade/endpoint/deletar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbDelete($parameter = NULL)
    {
        ...
        #
        $loadView5 = array(
            'fia/ptpa/generoidentidade/excluir',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        #
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'EXCLUIR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - EXCLUIR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/generoidentidade/endpoint/limpar/(:any)
    # route POST /www/index.php/fia/ptpa/generoidentidade/endpoint/limpar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbCleanner($parameter = NULL)
    {
        ...
        #
        $loadView5 = array(
            'fia/ptpa/generoidentidade/lixeira',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        #
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'LIMPAR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LIMPAR GENERO IDENTIDADE',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
