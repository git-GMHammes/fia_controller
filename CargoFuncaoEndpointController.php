...
class CargoFuncaoEndpointController extends ResourceController
{
    use ResponseTrait;
    ...
    public function dbRead($parameter = NULL)
    {
        ...
        #
        $loadView5 = array(
            'fia/ptpa/cargofuncao/AppForm',
            'fia/ptpa/cargofuncao/AppListar',
            $this->app_footer,
        );
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'LISTAR CARGO/FUNÇÃO',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LISTAR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
    ...
    public function dbCreate($parameter = NULL)
    {
        ...
        $loadView5 = array(
            'fia/ptpa/cargofuncao/AppForm',
            'fia/ptpa/cargofuncao/AppCadastrar',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        #
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'CADASTRAR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - CADASTRAR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    public function dbUpdate($parameter = NULL)
    {
        ...
        $loadView5 = array(
            'fia/ptpa/cargofuncao/AppForm',
            'fia/ptpa/cargofuncao/AppAtualizar',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        #
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'ATUALIZAR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - ATUALIZAR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    public function dbDelete($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'EXCLUIR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - EXCLUIR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    public function dbCleanner($parameter = NULL)
    {
        ...
        #
        $loadView5 = array(
            'fia/ptpa/cargofuncao/AppLimparCargoFuncao',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        #
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'LIMPAR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LIMPAR CARGO/FUNÇÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
