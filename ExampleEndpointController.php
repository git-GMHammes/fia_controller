...
private $app_message = 'fia/ptpa/AppMessage';
    ...
    # Consumo de API
    # route GET /exemple/group/endpoint/exemploForm/(:any)
    # route POST /exemple/group/endpoint/exemploForm/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function modelForm($parameter = NULL)
    {
        // $this->token_csrf();
...
$this->app_message,
            $this->app_loading,
            'analise/snippets/React_useEffect1',
            $this->app_footer,
        );
    ...
    public function displayAPI($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'SIMULADOR PARA O FIA PTPA',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
    ...
    public function gov_br($parameter = NULL)
    {
        // $this->token_csrf();
        $request = service('request');
        $getMethod = $request->getMethod();
        ...
        // $processRequest = eagarScagaire($processRequest);
        //
        // $myEndPoint = myEndPoint('index.php/fia/ptpa/profissional/api/filtrar?page=1&limit90000', '123');
        $funcionario = isset($myEndPoint['result']['dbResponse']) ? $myEndPoint['result']['dbResponse'] : array();
        $loadView = array(
            // $this->app_head,
            // $this->app_menu,
            // $this->message,
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'SIMULADOR PARA O FIA PTPA - GOV.BR',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - SIMULADOR PARA O FIA PTPA ',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
