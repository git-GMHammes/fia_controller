...
class PeriodoEndpointController extends ResourceController
{
    use ResponseTrait;
    ...
    public function dbConsult($parameter = NULL)
    {
        ...
        #
        $loadView5 = array(
            'fia/ptpa/periodo/AppForm',
            'fia/ptpa/periodo/AppConsultar',
            $this->app_footer,
        );
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/periodo/api/exibir/(:any)
    # route POST /www/index.php/fia/ptpa/periodo/api/exibir/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbRead($parameter = NULL)
    {
        ...
        $loadView5 = array(
            'fia/ptpa/periodo/AppForm',
            'fia/ptpa/periodo/AppListarConteudo',
            'fia/ptpa/periodo/AppListar',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        try {
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/periodo/endopint/cadastrar/(:any)
    # route POST /www/index.php/fia/ptpa/periodo/endopint/cadastrar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbCreate($parameter = NULL)
    {
        ...
        $loadView5 = array(
            'fia/ptpa/periodo/AppForm',
            'fia/ptpa/periodo/AppCadastrar',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        // myPrint($loadView, 'src\app\Controllers\PeriodoEndpointController.php');
        $this->tokenCsrf->token_csrf();
        try {
            # URI da API                                                                                                          
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - CADASTRAR PERÍODO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/periodo/endpoint/atualizar/(:any)
    # route POST /www/index.php/fia/ptpa/periodo/endpoint/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbUpdate($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - ATUALIZAR PERÍODO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
