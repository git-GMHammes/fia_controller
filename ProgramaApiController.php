...
use App\Controllers\ProgramaDbController;
// use App\Controllers\SystemUploadDbController;

use Exception;

class ProgramaApiController extends ResourceController
{
    use ResponseTrait;
    ...
    {
        $this->DbController = new ProgramaDbController();
    ...
    # route POST /www/Programa/group/api/criar/(:any)
    # route GET /www/Programa/group/api/criar/(:any)
    # route POST /Programa/group/api/atualizar/(:any)
    # route GET /Programa/group/api/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST /www/index.php/fia/ptpa/programa/api/exibir/(:any)
    # route GET /www/index.php/fia/ptpa/programa/api/exibir/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    public function dbFilter($parameter = NULL)
    {
        ...
        $json = isset($processRequest['json']) && $processRequest['json'] == 1 ? 1 : 0;
        #
        // myPrint($processRequest, 'src\app\Controllers\ProgramaApiController.php');
        try {
            #
            // return $this->response->setJSON($processRequest, 200);
            $requestDb = $this->DbController->dbFilter($processRequest, $page);
            // myPrint($requestDb, 'src\app\Controllers\ProgramaApiController.php', true);
            #
            $apiRespond = [
                'status' => 'success',
                'message' => 'API loading data (dados para carregamento da API)',
    ...
    # route POST /www/Programa/group/api/excluir/(:any)
    # route GET /www/Programa/group/api/excluir/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST /www/Programa/group/api/limpar/(:any)
    # route GET /www/Programa/group/api/limpar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
