...
class ResponsavelEndpointController extends ResourceController
{
    use ResponseTrait;
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/responsavel/endpoint/exibir/(:any)
    # route POST /www/index.php/fia/ptpa/responsavel/endpoint/exibir/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbRead($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LISTAR RESPONSAVEL',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/responsavel/endpoint/criar/(:any)
    # route POST /www/index.php/fia/ptpa/responsavel/endpoint/criar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbCreate($parameter = NULL)
    {
        ...
        #
        $loadView5 = array(
            'fia/ptpa/responsavel/formulario',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        #
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'CADASTRAR RESPONSAVEL',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - CADASTRAR RESPONSAVEL',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/responsavel/endpoint/atualizar/(:any)
    # route POST /www/index.php/fia/ptpa/responsavel/endpoint/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbUpdate($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'ATUALIZAR RESPONSAVEL',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - ATUALIZAR RESPONSAVEL',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/responsavel/endpoint/deletar/(:any)
    # route POST /www/index.php/fia/ptpa/responsavel/endpoint/deletar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbDelete($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'EXCLUIR RESPONSAVEL',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - EXCLUIR RESPONSAVEL',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/responsavel/endpoint/limpar/(:any)
    # route POST /www/index.php/fia/ptpa/responsavel/endpoint/limpar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbCleanner($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LIMPAR RESPONSAVEL',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
