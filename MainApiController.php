...
use App\Controllers\MainDbController;
...
class MainApiController extends ResourceController
{
    ...
    {
        $this->DbController = new MainDbController();
    ...
    # route POST /www/index.php/fia/ptpa/principal/api/indicadores/(:any)
    # route GET /www/index.php/fia/ptpa/principal/api/indicadores/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbRead($parameter = NULL)
    {
        ...
        try {
            ...
            $requestDb = $this->DbController->dbRead();
            // myPrint($requestDb, 'src\app\Controllers\MainApiController.php');
            #
            $apiRespond = [
                'status' => 'success',
