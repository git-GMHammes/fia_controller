...
class UsuarioEndpointController extends ResourceController
{
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/usuario/endpoint/seguranca/(:any)
    # route POST /www/index.php/fia/ptpa/usuario/endpoint/seguranca/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function painelSeguranca($parameter = NULL)
    {
        // $this->token_csrf();
        ...
        #
        $loadView5 = array(
            'fia/ptpa/usuarios/AppManutencao',
            'fia/ptpa/usuarios/AppRota',
            'fia/ptpa/usuarios/AppMenu',
            'fia/ptpa/usuarios/AppPainel',
            $this->app_footer,
        );
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'Painel de Segurança',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - Painel de Segurança',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/usuario/endpoint/menu/(:any)
    # route POST /www/index.php/fia/ptpa/usuario/endpoint/menu/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function menuPainel($parameter = NULL)
    {
        // $this->token_csrf();
        $request = service('request');
        $getMethod = $request->getMethod();
        ...
        try {
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - Painel de Menu',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
