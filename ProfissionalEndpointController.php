...
class ProfissionalEndpointController extends ResourceController
{
    use ResponseTrait;
    ...
    public function dbConsult($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'CONSULTAR FUNCIONÁRIO',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - CONSULTAR FUNCIONÁRIO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/profissional/api/exibir/(:any)
    # route POST /www/index.php/fia/ptpa/profissional/api/exibir/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbRead($parameter = NULL)
    {
        ...
        $json = isset($processRequest['json']) && $processRequest['json'] == 1 ? 1 : 0;
        $id = (isset($processRequest['id'])) ? ('/' . $processRequest['id']) : ('/' . $parameter);
        // $processRequest = $this->DbController->dbRead($id);
        #
        $loadView1 = array(
            $this->app_head,
            $this->app_menu,
        ...
        $loadView4 = $this->viewFormatacao->camposFormatacao();
        #
        // myPrint($loadView2, 'src\app\Controllers\UnidadeEndpointController.php', true);
        #
        $loadView5 = array(
            'fia/ptpa/profissional/AppForm',
            'fia/ptpa/profissional/AppListarConteudo',
            'fia/ptpa/profissional/AppListar',
            $this->app_footer,
        );
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        #
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/profissional/endpoint/cadastrar/(:any)
    # route POST /www/index.php/fia/ptpa/profissional/endpoint/cadastrar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbCreate($parameter = NULL)
    {
        ...
        $loadView = array_merge($loadView1, $loadView2, $loadView3, $loadView4, $loadView5);
        // myPrint($loadView, 'src\app\Controllers\UnidadeEndpointController.php');
        try {
            $this->tokenCsrf->token_csrf();
            $requestJSONform = array();
            $apiRespond = [
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - CADASTRAR FUNCIONÁRIO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/profissional/endpoint/atualizar/(:any)
    # route POST /www/index.php/fia/ptpa/profissional/endpoint/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbUpdate($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'ATUALIZAR FUNCIONÁRIO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - ATUALIZAR FUNCIONÁRIO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/profissional/endpoint/deletar/(:any)
    # route POST /www/index.php/fia/ptpa/profissional/endpoint/deletar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbDelete($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'EXCLUIR FUNCIONÁRIO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - EXCLUIR FUNCIONÁRIO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
    ...
    # Consumo de API
    # route GET /www/index.php/fia/ptpa/profissional/endpoint/limpar/(:any)
    # route POST /www/index.php/fia/ptpa/profissional/endpoint/limpar/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function dbCleanner($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LIMPAR FUNCIONÁRIO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
