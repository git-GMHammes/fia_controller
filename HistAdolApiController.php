...
use App\Controllers\HistAdolDbController;
# 
use Exception;

class HistAdolApiController extends ResourceController
{
    use ResponseTrait;
    ...
    public function __construct()
    {
        ...
        $this->DbController = new HistAdolDbController();
    ...
    # route POST /www/index.php/fia/ptpa/historicoadolescente/api/criar/(:any)
    # route GET /www/index.php/fia/ptpa/historicoadolescente/api/criar/(:any)
    # route POST /www/index.php/fia/ptpa/historicoadolescente/api/atualizar/(:any)
    # route GET /www/index.php/fia/ptpa/historicoadolescente/api/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST /www/index.php/fia/ptpa/historicoadolescente/api/exibir/(:any)
    # route GET /www/index.php/fia/ptpa/historicoadolescente/api/exibir/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbRead($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'result' => $requestDb,
                'metadata' => [
                    'page_title' => 'Listar Histórico de Adolescentes',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
