...
use App\Controllers\MunicipiosDbController;
// use App\Controllers\SystemUploadDbController;

use Exception;

class MunicipiosApiController extends ResourceController
{
    use ResponseTrait;
    ...
    {
        $this->DbController = new MunicipiosDbController();
    ...
    # route POST /www/index.php/fia/ptpa/municipio/api/exibir/(:any)
    # route GET /www/index.php/fia/ptpa/municipio/api/exibir/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST /# www/index.php/fia/ptpa/municipio/api/filtrar/(:any)
    # route GET /# www/index.php/fia/ptpa/municipio/api/filtrar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
