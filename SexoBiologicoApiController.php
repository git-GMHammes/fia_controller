...
use App\Controllers\SexoBiologicoDbController;
// use App\Controllers\SystemUploadDbController;

use Exception;

class SexoBiologicoApiController extends ResourceController
{
    use ResponseTrait;
    ...
    {
        $this->DbController = new SexoBiologicoDbController();
    ...
    # route POST /www/index.php/fia/ptpa/genero/api/exibir/(:any)
    # route GET /www/index.php/fia/ptpa/genero/api/exibir/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
