...
use App\Controllers\UnidDisponibilidadeDbController;
// use App\Controllers\SystemUploadDbController;

use Exception;

class UnidDisponibilidadeApiController extends ResourceController
{
    use ResponseTrait;
    ...
    {
        $this->DbController = new UnidDisponibilidadeDbController();
    ...
    public function dbFilter($parameter = NULL)
    {
        ...
        $json = isset($processRequest['json']) && $processRequest['json'] == 1 ? 1 : 0;
        // myPrint($processRequest, 'src\app\Controllers\UnidDisponibilidadeApiController.php');
        #
        try {
            #
            ...
            // myPrint($requestDb, 'src\app\Controllers\UnidDisponibilidadeApiController.php', true);
            #
            $apiRespond = [
                'status' => 'success',
                'message' => 'API loading data (dados para carregamento da API)',
    ...
    public function dbDelete($parameter1 = NULL, $parameter2 = NULL)
    {
        ...
        try {
            if (
                ...
                // myPrint($parameter1, 'src\app\Controllers\AdolescenteApiController.php, 268');
                #
