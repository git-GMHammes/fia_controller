...
class ProfissaoEndpointController extends ResourceController
{
    use ResponseTrait;
    ...
    public function dbRead($parameter = NULL)
    {
        ...
        #
        $loadView5 = array(
            'fia/ptpa/profissao/AppListarProfissao',
            $this->app_footer,
        );
        ...
        try {
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LISTAR PROFISSÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
    ...
    public function dbCreate($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'CADASTRAR PROFISSÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - CADASTRAR PROFISSÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    public function dbUpdate($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'loadView' => $loadView,
                'metadata' => [
                    'page_title' => 'ATUALIZAR PROFISSÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    // Você pode adicionar campos comentados anteriormente se forem relevantes
                    // 'method' => '__METHOD__',
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - ATUALIZAR PROFISSÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
    ...
    public function dbDelete($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - EXCLUIR PROFISSÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                    'getVar_page' => $getVar_page,
                ]
    ...
    public function dbCleanner($parameter = NULL)
    {
        ...
        try {
            ...
            $apiRespond = [
                ...
                'metadata' => [
                    'page_title' => 'ERRO - LIMPAR PROFISSÃO',
                    'getURI' => $this->uri->getSegments(),
                    'environment' => ENVIRONMENT_CHOICE,
                ]
            ];
