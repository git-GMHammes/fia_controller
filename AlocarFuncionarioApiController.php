...
use App\Controllers\AlocarFuncionarioDbController;
// use App\Controllers\SystemUploadDbController;

use Exception;

class AlocarFuncionarioApiController extends ResourceController
{
    use ResponseTrait;
    ...
    {
        $this->DbController = new AlocarFuncionarioDbController();
    ...
    # route POST www/index.php/fia/ptpa/alocarfuncionario/api/criar/(:any)
    # route GET www/index.php/fia/ptpa/alocarfuncionario/api/criar/(:any)
    # route POST www/index.php/fia/ptpa/alocarfuncionario/api/atualizar/(:any)
    # route GET www/index.php/fia/ptpa/alocarfuncionario/api/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function create_update($parameter = NULL)
    {
        ...
        if ($json) {
            ...
            // return $response;
            return redirect()->to('index.php/fia/ptpa/alocarfuncionario/endpoint/exibir');
        }
    }

    # route POST /www/index.php/fia/ptpa/alocarfuncionario/api/consultar/(:any)
    # route GET /www/index.php/fia/ptpa/alocarfuncionario/api/consultar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbConsult($parameter = NULL)
    {
        ...
        try {
            ...
            $requestDb = $this->DbController->dbConsult($id, $page);
            // exit('src\app\Controllers\AlocarFuncionarioApiController.php');
            #
            $apiRespond = [
                'status' => 'success',
    ...
    # route POST /# www/index.php/fia/ptpa/alocarfuncionario/api/filtrar/(:any)
    # route GET /# www/index.php/fia/ptpa/alocarfuncionario/api/filtrar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbFilter($parameter = NULL)
    {
        ...
        $json = isset($processRequest['json']) && $processRequest['json'] == 1 ? 1 : 0;
        #
        // myPrint($processRequest, 'src\app\Controllers\AlocarFuncionarioApiController.php');
        try {
            #
            // return $this->response->setJSON($processRequest, 200);
            $requestDb = $this->DbController->dbFilter($processRequest);
            // myPrint($requestDb, 'src\app\Controllers\AlocarFuncionarioApiController.php');
            #
            $apiRespond = [
                'status' => 'success',
                'message' => 'API loading data (dados para carregamento da API)',
    ...
    public function dbDelete($parameter1 = NULL, $parameter2 = NULL)
    {
        ...
        if ($json == 1) {
            ...
            // return $response;
            return redirect()->back();
            // return redirect()->to('fia/ptpa/alocarfuncionario/endpoint/exibir');
        }
    }
